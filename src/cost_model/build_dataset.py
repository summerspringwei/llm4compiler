...
def build_instruction_dataset(data_path: Union[List[str],str],
    ...
    def tokenization(examples):
        ...
        for instruction, code1, code2, output in zip(examples['instruction:'], examples['code1:'],
                                                     examples['code2:'], examples['output']):
    ...
    for file in data_path:
        ...
        try:
            ...
            tokenized_dataset = raw_dataset.map(
                ...
                remove_columns=["instruction:","code1:","code2:","output"],
